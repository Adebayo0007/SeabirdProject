...
namespace SeaBirdProject.GateWay.Email
{
    public class EmailSender : IEmailSender
    {
        ...
        public async Task<bool> SendEmail(EmailRequestModel email)
        {
            ...
            var apiKey = _configuration.GetValue<string>("BrevoAPIkey:ApiKey");
            ...
            string SenderName = "SeaBird Vivid";
            ...
            string ReplyToName = "SeaBird Vivid";
